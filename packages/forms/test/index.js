...
import { Label, Input, Select, Textarea, Radio, Checkbox } from "../src";
...
describe("Select", () => {
  ...
  test("margin props are applied to the wrapping element", () => {
    const json = renderJSON(<Select mb={3} mt={2} />);
...
describe("Textarea", () => {
  test("renders", () => {
    const json = renderJSON(<Textarea />);
    expect(json).toMatchSnapshot();
  });
  test("passes ref", () => {
    const ref = React.createRef(null);
...
describe("Checkbox", () => {
  test("renders", () => {
    const json = renderJSON(<Checkbox />);
    expect(json).toMatchSnapshot();
  });
  test("passes ref", () => {
    const ref = React.createRef(null);
