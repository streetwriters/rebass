...
please open an issue or pull request on [GitHub](https://github.com/streetwriters/rebass).
...
To fully understand any API in CSS, I _highly_ recommend reading the specification, since it is the authoritative source for how CSS is intended to work:
